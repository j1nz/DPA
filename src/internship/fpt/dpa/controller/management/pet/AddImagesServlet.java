...
public class AddImagesServlet extends HttpServlet {
	...
	public void checkMulti(HttpServletRequest request, HttpServletResponse response) throws IOException {
	...
	protected void getImages(HttpServletRequest request, HttpServletResponse response) {
